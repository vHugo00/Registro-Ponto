...
switch ($tipo_registro) {
  ...
  case "editar":
    ...
    $query_horario = "UPDATE pontos SET $col_tipo_registro = :horario_atual, usuario_ip = :usuario_ip
                    WHERE id=:id
                    LIMIT 1";
    ...
    $cad_horario->bindParam(':usuario_ip', $usuario_ip);
    $cad_horario->bindParam(':id', $id_ponto);
    break;
  default:
    // Query para cadastrar no banco de dados
    $query_horario = "INSERT INTO pontos (data_entrada, entrada, usuario_id, usuario_ip) VALUES (:data_entrada, :entrada, :usuario_id, :usuario_ip)";
